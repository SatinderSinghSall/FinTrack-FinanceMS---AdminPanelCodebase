      ...
      <div className="w-full max-w-lg overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-2xl">
        ...
        <div className="max-h-[70vh] overflow-y-auto p-5 sm:p-6">
          <div className="space-y-5">
            <Detail label="Goal" value={saving.goal || "—"} />

            <Detail label="Amount" value={formatCurrency(saving.amount)} />

            <Detail label="User ID" value={saving.userId || "—"} mono />

            <Detail label="Saving ID" value={saving._id} mono />

            <Detail label="Created" value={formatDate(saving.createdAt)} />

            <Detail label="Updated" value={formatDate(saving.updatedAt)} />
          </div>
        </div>
