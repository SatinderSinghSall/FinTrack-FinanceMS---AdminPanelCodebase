          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-zinc-400">
                Update user credentials and security profile
              </p>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    ...
                    className="h-10 w-full rounded-xl border border-zinc-200/80 bg-white pl-10 pr-4 text-xs font-medium text-zinc-900 shadow-sm outline-none transition duration-200 placeholder:text-zinc-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 disabled:bg-zinc-50 disabled:text-zinc-400"
                  />
                </div>
              </div>
