...
export default function DeleteSavingModal({
  ...
  const handleDelete = async () => {
    try {
      ...
      setError(err instanceof Error ? err.message : "Unable to delete saving.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="p-6">
          ...
          <div className="mt-4">
            ...
            <p className="mt-1.5 text-xs font-medium leading-relaxed text-zinc-500">
              You are about to permanently delete this savings goal record. This
              action cannot be undone.
            </p>
          </div>

          {/* Savings Details Target Box */}
          <div className="mt-5 space-y-3 rounded-2xl border border-red-100 bg-red-50/40 p-4">
            ...
            <div className="flex items-start justify-between gap-2 pt-1">
              ...
              <div className="text-right">
                ...
                <p className="mt-0.5 text-sm font-semibold text-emerald-600 font-mono">
