...
export default function DeleteIncomeModal({
  ...
  const handleDelete = async () => {
    try {
      ...
      setError(err instanceof Error ? err.message : "Unable to delete income.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="p-6">
          ...
          <div className="mt-4">
            ...
            <p className="mt-1.5 text-xs font-medium leading-relaxed text-zinc-500">
              You are about to permanently delete this income entry. This action
              cannot be undone.
            </p>
          </div>

          {/* Income Details Target Box */}
