          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-zinc-400">
                Complete system record for administrator account
              </p>
            </div>
          </div>
        ...
        <div className="max-h-[70vh] overflow-y-auto p-6 space-y-5">
          ...
          <div className="rounded-2xl border border-zinc-200/80 bg-gradient-to-br from-zinc-50/80 via-white to-zinc-50/50 p-4 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="inline-flex items-center gap-1 rounded-full border border-zinc-200 bg-zinc-100 px-2.5 py-1 text-xs font-medium text-zinc-800 shadow-sm">
